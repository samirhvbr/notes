...
> **Status:** `ACTIVE` · Last reviewed 10/09/2026, repository at 0.20.5
...
| [Milestone 0.6 — sync](0.6-sync.md) | Domain, server inbox, device transfer and guarded closed-workspace creations/updates plus explicit device acknowledgments implemented through `0.20.3`; exclusive open-session core foundation in `0.20.5`. Frontend application, conflicts, broader pairing, attachments, scheduling and UI remain open | Implementation / Samir |
