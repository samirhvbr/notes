...
> **Status:** `ACTIVE` · Last reviewed 10/09/2026, repository at 0.20.2
...
| [Milestone 0.6 — sync](0.6-sync.md) | Domain, server inbox, device transfer and guarded closed-workspace creations/updates implemented through `0.20.1`; active-editor application, device acknowledgments, conflicts, broader pairing, attachments, scheduling and UI remain open | Implementation / Samir |
...
1. Finish sync 0.6: active-editor application and device acknowledgments,
