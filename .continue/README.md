...
> **Status:** `ACTIVE` · Last reviewed 10/09/2026, repository at 0.16.0
...
| **Milestone 0.4 — mobile** | Foundation in [PR #2](https://github.com/samirhvbr/notes/pull/2), independently developed; reconcile its reserved version and ADR numbering when merging | Mobile agent / Samir |
