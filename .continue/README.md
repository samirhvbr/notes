...
> **Status:** `ACTIVE` · Last reviewed 10/09/2026, repository at 0.20.3
...
| [Milestone 0.6 — sync](0.6-sync.md) | Domain, server inbox, device transfer and guarded closed-workspace creations/updates plus explicit device acknowledgments implemented through `0.20.3`; active-editor application, conflicts, broader pairing, attachments, scheduling and UI remain open | Implementation / Samir |
...
1. Finish sync 0.6: active-editor application,
