...
> **Status:** `ACTIVE` · Last reviewed 11/09/2026, repository at 0.20.15
...
1. Finish sync 0.6: retention/pruning, older-client reconciliation, broader device tests and owner acceptance. The detailed ordered queue is in
