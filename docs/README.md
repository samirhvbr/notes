...
|---|---|
| [ACCEPTANCE-0.1a.md](ACCEPTANCE-0.1a.md) | **Every 0.1a acceptance criterion against a named test or a documented manual step**, with the measurements — and the one criterion that is only partly met, said so. |
